...
export function printPassportWithdrawalForm(form) {
  ...
  const html = `
    ...
    <html>
      <head>
        <meta charset="utf-8" />
        <title>Passport Withdrawal Form</title>
        <style>
          @page {
            size: A4 portrait;
            margin: 8mm;
      ...
      <body>
        <div class="page">
          <div class="header">
            ...
            <div class="heading">
              <h1>PASSPORT WITHDRAWAL FORM</h1>
          ...
          <div class="summary">
            ...
            <div class="summary-card">
              ...
              <strong>${escapeHtml(form.passport_number || '-')}</strong>
            </div>
            <div class="summary-card">
              <span>Withdrawal Date</span>
              <strong>${escapeHtml(form.withdrawal_date_label || form.withdrawal_date || '-')}</strong>
            </div>
          </div>

          <div class="section">
            <div class="section-head"><strong>Withdrawal Details</strong></div>
            ${buildRow('NAME OF PERSON', form.employee_name)}
            ${buildRow('PASSPORT NO.', form.passport_number)}
            ${buildRow('DESIGNATION', form.designation)}
            ${buildRow('BRANCH', form.branch)}
            ${buildRow('PASSPORT WITHDRAWAL DATE', form.withdrawal_date_label || form.withdrawal_date)}
            ${buildRow('REASON', form.reason)}
            ${buildRow('SIM CARD (to be collected, if any)', form.sim_card_status)}
            ${buildRow('NO DUE CONFIRMATION/ WORK HANDING OVER', form.no_due_status)}
          </div>
          ...
          <div class="approvals">
            <div class="approval-card">
              <strong>Approved By<br />Accounts Manager</strong>
            </div>
            <div class="approval-card">
