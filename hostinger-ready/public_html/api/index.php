...
require dirname(__DIR__, 2) . '/private_app/bootstrap/autoload.php';
require dirname(__DIR__, 2) . '/private_app/src/Support/helpers.php';

Env::load(dirname(__DIR__, 2) . '/private_app');
