...
export default function EmployeeDocumentsPage() {
  ...
  async function loadRows() {
    const { data } = await api.employeeDocuments();
    setRows(data.data);
  }
  ...
  return (
    ...
    >
      ...
      <SectionCard title="Document Register" subtitle="Passport, visa, EID, labour, insurance, contracts, and custom master-based documents.">
